...
import { FaBell, FaBars, FaTimes, FaHome, FaFileContract, FaUser, FaDoorOpen } from 'react-icons/fa'
        ...
        <div>
            <header className="navbar sticky-top bg-primary flex-md-nowrap px-2 shadow" data-bs-theme="dark">
                <ul className='flex-row navbar-nav col-md-3 col-lg-2 me-0 flex-grow-1'>
                    ...
                    <li>
                        <Link to='/' className="navbar-brand text-nowrap fs-4 px-md-3 text-white">Company name</Link>
                    </li>
                </ul>
                <div className='pe-3'>
                ...
                <div className="dropdown pe-3 text-end">
                    <Link to='' className="d-block link-body-emphasis dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src={logo} alt="mdo" width="25" height="25" className="rounded-circle"/> Admin
                    </Link>
